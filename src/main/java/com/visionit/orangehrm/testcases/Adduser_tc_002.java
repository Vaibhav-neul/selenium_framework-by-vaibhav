...
public class Adduser_tc_002 extends TestBase {
	...
	public void addnewusertest(String user_role,String empname,String username,String 
		...
		homepage hp=login.loginorangehrm(exceldata.getstringcelldata("vaibhav1", 0, 0), 
				exceldata.getstringcelldata("vaibhav1", 0, 1));
	...
	public Object[][] getexceldata(){
		Object[][] data=exceldata.exceltestdata("vaibhav1");
		return data;
	}
}
